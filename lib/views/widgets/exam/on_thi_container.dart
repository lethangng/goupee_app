...
import 'button_exam.dart';
// import 'dialog_dung_dap_an_mau.dart';

class OnThiContainer extends StatelessWidget {
  OnThiContainer({
    super.key,
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  visible: question.unLock.value,
                  child: Obx(() {
                    if (_onThiViewModel.explainRes.value.status ==
                        Status.error) {
                      showDialogError(
                          error: _onThiViewModel.explainRes.value.message!);
                    }
        ...
        child: Column(
          children: [
            ...
            button(
              ...
              event: () {
                Get.back();
                _onThiViewModel.handleViewDapAn();
              },
              typeImageSvg: false,
            ),
          ],
